...
export default function FeaturePage() {
  const items = [
    { t: "Production Model v2.3", d: "Accuracy: 94.2% • F1: 0.91 • Latency: 45ms • Drift: None detected", s: "healthy" },
    { t: "Staging Model v2.4", d: "Accuracy: 95.1% • F1: 0.93 • Ready for promotion • +0.9% improvement", s: "improved" },
    { t: "Feature Drift Alert", d: "Input feature \"price\" distribution shifted 15% • Investigate data source", s: "warning" },
    { t: "Prediction Volume", d: "Today: 12,450 predictions • Avg confidence: 87% • Low confidence (<60%): 3.2%", s: "info" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Model Performance</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Monitor AI model accuracy and drift</p>
